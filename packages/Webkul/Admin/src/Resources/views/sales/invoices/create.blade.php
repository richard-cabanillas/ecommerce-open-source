...
@pushOnce('scripts')
    ...
    @if ($item->qty_to_invoice || $order->payment->method === 'cashondelivery')
            ...
            <div class="grid ltr:text-right rtl:text-left">
                ...
                <x-admin::form.control-group>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        :value="($item->qty_to_invoice && $item->qty_to_invoice > 0) ? $item->qty_to_invoice : ($order->payment->method === 'cashondelivery' ? $item->qty_ordered : 0)"
